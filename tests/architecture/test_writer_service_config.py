...
def test_local_n8n_init_updates_all_workflows_in_place():
    ...
    assert "import_or_update_workflow(eh_json)" in script
    assert "import_or_update_workflow(intake_json)" in script
    assert "import_or_update_workflow(daily_digest_json)" in script
    assert "import_or_update_workflow(weekly_review_json)" in script
